 ...
 */
final class Version20200917194231 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE Wanted.persons (person_id SMALLINT AUTO_INCREMENT NOT NULL, full_name VARCHAR(255) NOT NULL, is_wanted TINYINT(1) NOT NULL, date_of_birth DATE DEFAULT NULL, created_date DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(person_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'A person.\' ');
